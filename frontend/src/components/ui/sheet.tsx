...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        'data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 fixed inset-0 z-50 duration-100',
        className
      )}
      {...props}
    />
          ...
          {showCloseButton && (
            ...
            >
              <Button
                ...
                size="icon-sm"
              >
                <XIcon className="text-text-main !h-8 !w-8" />
